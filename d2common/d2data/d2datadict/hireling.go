...
func LoadHireling(file []byte) {
	...
	for idx, _ := range d.Data {
		hireling := &HirelingRecord{
			...
			DmgMin:          d.GetNumber("DmgMin", idx),
			DmgMax:          d.GetNumber("DmgMax", idx),
			DmgPerLvl:       d.GetNumber("DmgPerLvl", idx),
			...
			ChancePerLevel1: d.GetNumber("ChancePerLevel1", idx),
			...
			ChancePerLevel2: d.GetNumber("ChancePerLevel2", idx),
			...
			ChancePerLevel3: d.GetNumber("ChancePerLevel3", idx),
			...
			ChancePerLevel4: d.GetNumber("ChancePerLevel4", idx),
			...
			ChancePerLevel5: d.GetNumber("ChancePerLevel5", idx),
			...
			ChancePerLevel6: d.GetNumber("ChancePerLevel6", idx),
