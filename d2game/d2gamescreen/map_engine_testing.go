...
func getRegions() []regionSpec {
	return []regionSpec{
		// Act I
		{[]int{}, d2enum.RegionAct1Town, 1, 3},
		{
			[]int{
				108,
				160, 161, 162, 163, 164,
			},
			d2enum.RegionAct1Wilderness, 4, 52,
		},
		{[]int{}, d2enum.RegionAct1Cave, 53, 107},
		{[]int{}, d2enum.RegionAct1Crypt, 109, 159},
		{[]int{}, d2enum.RegionAct1Monestary, 165, 165},
		{[]int{256}, d2enum.RegionAct1Courtyard, 166, 166},
		{[]int{}, d2enum.RegionAct1Barracks, 167, 205},
		{[]int{}, d2enum.RegionAct1Jail, 206, 255},
		{[]int{}, d2enum.RegionAct1Cathedral, 257, 257},
		{[]int{}, d2enum.RegionAct1Catacombs, 258, 299},
		{[]int{}, d2enum.RegionAct1Tristram, 300, 300},

		// Act II
		{[]int{}, d2enum.RegionAct2Town, 301, 301},
		{[]int{}, d2enum.RegionAct2Sewer, 302, 352},
		{[]int{}, d2enum.RegionAct2Harem, 353, 357},
		{[]int{}, d2enum.RegionAct2Basement, 358, 361},
		{[]int{}, d2enum.RegionAct2Desert, 362, 413},
		{[]int{}, d2enum.RegionAct2Tomb, 414, 481},
		{[]int{}, d2enum.RegionAct2Lair, 482, 509},
		{[]int{}, d2enum.RegionAct2Arcane, 510, 528},

		// Act III
		{[]int{}, d2enum.RegionAct3Town, 529, 529},
		{[]int{}, d2enum.RegionAct3Jungle, 530, 604},
		{
			[]int{
			...
			d2enum.RegionAct3Kurast, 605, 658,
		},
		{[]int{}, d2enum.RegionAct3Spider, 659, 664},
		{[]int{}, d2enum.RegionAct3Dungeon, 665, 704},
		{[]int{}, d2enum.RegionAct3Sewer, 705, 747},

		// Act IV
		{[]int{}, d2enum.RegionAct4Town, 797, 798},
		{[]int{}, d2enum.RegionAct4Mesa, 799, 835},
		{[]int{}, d2enum.RegionAct4Lava, 836, 862},

		// Act V -- broken or wrong order
		{[]int{}, d2enum.RegonAct5Town, 863, 864},
		{[]int{}, d2enum.RegionAct5Siege, 865, 879},
		{[]int{}, d2enum.RegionAct5Barricade, 880, 1002},
		{[]int{}, d2enum.RegionAct5IceCaves, 1003, 1041},
		{[]int{}, d2enum.RegionAct5Temple, 1042, 1052},
		{[]int{}, d2enum.RegionAct5Baal, 1059, 1090},
		{[]int{}, d2enum.RegionAct5Lava, 1053, 1058},
	}
}
