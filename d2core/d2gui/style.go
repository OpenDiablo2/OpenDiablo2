...
func getFontStyleConfigs() map[FontStyle]fontStyleConfig {
	return map[FontStyle]fontStyleConfig{
...
//Get constant map of button style configurations
func getButtonStyleConfigs() map[ButtonStyle]buttonStyleConfig {
	return map[ButtonStyle]buttonStyleConfig{
