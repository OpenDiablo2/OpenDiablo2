...
// Object is a static entity. It may have an animation but it does not move.
type Object struct {
	mapEntity
...
func (ob *Object) SetMode(animationMode, weaponClass string, direction int) error {
	...
	// For objects their txt record entry overrides animation data
...
// Highlight sets a flag on this entity telling the renderer
// to highlight it and display it's name in text.
