...
func (v *Player) Advance(tickTime float64) {
	...
	if v.composite.GetAnimationMode().String() != v.animationMode {
		v.animationMode = v.composite.GetAnimationMode().String()
	}
}
...
func (v *Player) rotate(direction int) {
	...
	if newAnimationMode.String() != v.composite.GetAnimationMode().String() {
