...
func LoadComposite(basePath, token, palettePath string, equipment *[d2enum.CompositeTypeMax]string) (*Composite, error) {
	return CreateComposite(basePath, token, palettePath, equipment), nil
}
